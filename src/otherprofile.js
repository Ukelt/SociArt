...
function OtherProfile() {
    ...
    useEffect(() => {
        ...
        if (userCookie && userUuid) {
            ...
            axios.get(`http://localhost:3001/api/profile?userId=${profileId}`, { withCredentials: true })
                .then(response => {
            ...
            // Fetch liked posts
            axios.get(`http://localhost:3001/api/liked-posts?userId=${profileId}`, { withCredentials: true })
                .then(response => {
            ...
            axios.get(`http://localhost:3001/api/reposted-posts?userId=${profileId}`, { withCredentials: true })
                .then(response => {
